	...
	bizmodel: [
		{
			...
			msg: [
				...
				`我的商业模式是【CONTEXT_DETAIL】, 在世界著名企业家或学者中, 哪些人在我所涉及的商业领域有深刻的认知和洞察?，请选择其中两位，比如是A和B，分别用他们的第一人称，你就是他，用他们自己的语言风格，来给我的商业模式做出详细评价和提出具体的建议，结合实际案例。不要考虑回复文字的限制，尽量展开说， 格式如下，替换A和B为他们的名字：
A: 我是A，A的评价和建议
B: 我是B，B的评价和建议`,
			],
		},
		{
			...
			followups: ["好的，请再进一步，就我的组织进行定制化建议和推荐"],
		},
	],
	marketing: [
		{
